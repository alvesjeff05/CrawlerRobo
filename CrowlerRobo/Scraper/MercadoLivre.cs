    ...
    public string ObterPreco(string descricaoProduto, int idProduto)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                // Registra o log com o ID do produto
                RegistrarLog("280597", "jeffalves", DateTime.Now, "WebScraping - Mercado Livre", "Preço não encontrado", idProduto);
        ...
        catch (Exception ex)
        {
            ...
            // Registra o log com o ID do produto
            RegistrarLog("280597", "jeffalves", DateTime.Now, "Web Scraping - Mercado Livre", $"Erro: {ex.Message}", idProduto);
